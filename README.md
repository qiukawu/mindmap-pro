...
> 功能强大的在线思维导图应用，支持 AI 智能生成、拖拽编辑、多选操作、离线使用等功能。
...
### 本地使用
下载后用浏览器打开 `mindmap.htm` 或 `index.html` 即可。
...
-  **多选批量操作** - 同时选中多个节点
-  **撤销/重做** - 完整的历史记录
-  **AI 智能生成** - 支持 OpenAI、Claude、DeepSeek、本地 Ollama 等服务
-  **折叠/展开** - 灵活的视图管理
-  **保存/导出** - 支持 JSON、PNG 导出
-  **多主题** - 内置 5 套配色方案
-  **快捷键** - 完整的键盘快捷键支持
-  **离线使用** - 无网络也能工作，所有数据本地保存
...
**本应用无需配置也能正常使用！** 配置 API 可解锁 AI 智能生成功能。
